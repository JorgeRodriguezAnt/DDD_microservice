...
public class CreateServiceImplementation {
    ...
    public void createFile(String nameService) {
        ...
        try {  
            File myObj = new File("C:\\Users\\JoJa Morrison\\Documents\\Tesis\\Proximo semestre\\implement\\" + serviceImplementClassName + nameService+".java");  
    ...
    public void writeFile(String nameService,List<TransformerClass> classesToTransform) {
        ...
        try {
            ...
            try (FileWriter myWriter = new FileWriter("C:\\Users\\JoJa Morrison\\Documents\\Tesis\\Proximo semestre\\implement\\" + serviceImplementClassName+ nameService+ ".java")) {
