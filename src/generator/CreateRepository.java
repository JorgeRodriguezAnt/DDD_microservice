...
public class CreateRepository {
    ...
    public void createFile(List<TransformerClass> classesToTransform) {
        ...
        try {  
            File myObj = new File("C:\\Users\\JoJa Morrison\\Documents\\Tesis\\Proximo semestre\\implement\\"  + nameRepository +".java");  
    ...
    public void writeFile(List<TransformerClass> classesToTransform) {
        ...
        try {
            ...
            try (FileWriter myWriter = new FileWriter("C:\\Users\\JoJa Morrison\\Documents\\Tesis\\Proximo semestre\\implement\\" + nameRepository +".java")) {
